...
// DWARF CFA instructions encodings (Section 7.23 and figure 40) in DWARFv3
enum class DW_CFA : ubyte
{
	nop			= 0x00,
	set_loc			= 0x01,
	advance_loc1		= 0x02,
	...
	lo_user			= 0x1c,
	hi_user			= 0x3f,
// Codes for "primary operations", assuming the 6 least significant bits are zeroed
	advance_loc		= 0x40,
	offset			= 0x80,
	restore			= 0xc0,
};
